...
arm=input('Ingresa el número de armonicos:   ');
a=-2*T0; b=3*T0;
% Serie de Fourier
sf=a0;
t=a:0.001:b;
...
legend('Función original(e^{-t/2})','Serie de Fourier ','Location','Best')
title('Serie de Fourier vs Función original','FontWeight','bold','FontSize',16)
xlabel('t','FontWeight','bold','FontSize',16)
axis auto
% Error
E=f(t1)-sf;
...
title('Energía del Error','FontWeight','bold','FontSize',16)
xlabel('t','FontWeight','bold','FontSize',16)
axis auto; grid on
end